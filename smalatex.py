...
nomsUE = dfCompositionSemestre['NomUE']
...
with docSyntheseSemestre.create(LongTable("c c c c")) as syntheseSemestre:
    ...
    #
    # Boucle sur l'ensemble des UE dans toute la maquette
    #

    UE_number = 0  # sert à générer les noms de fichiers (un fichier par UE)
    ...
    for nom_UE in nomsUE:
        ...
        matieresDansUE = dfUEmatieres[dfUEmatieres["NomUE"] == nom_UE]
